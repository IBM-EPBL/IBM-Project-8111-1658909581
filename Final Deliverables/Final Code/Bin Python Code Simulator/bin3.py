...
#generate random values for randomo variables (Distance and load)
...
while True:
    ...
    def myOnPublishCallback(lat=10.9568,long=78.1566):
        print("Chinnavedampatti, Coimbatore, Tamil Nadu")
